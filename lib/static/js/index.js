//post to server the rank method and retrieve the rank result
function get_rank(){
	var rank_way = document.getElementById("rank").value;
	...
	xmlhttp.open("POST", server+"/rank", false);
	xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	content = "rank="+rank_way+"&user="+user;
...
// load_select_option, when the main content is loaded completely
// first interactive with server to get the selection of field, skill, 
// hobby and school. Then through it to the front-end.
